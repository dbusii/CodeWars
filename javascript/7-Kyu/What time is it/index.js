...
var getMilitaryTime = function(input) {
  if (input.includes("AM") && input.substring(0,2) !== "12"){return input.substring(0,8)}
  if (input.includes("AM") && input.substring(0,2) === "12"){return `00${input.substring(2,8)}`}
  if (input.includes("PM") && input.substring(0,2) !== "12") {return `${Number(input.substring(0,2))+12}${input.substring(2,8)}`}
  if (input.includes("PM") && input.substring(0,2) === "12") {return `${input.substring(0,8)}`}
};